    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory factory, ObjectMapper objectMapper) {
        ...
        return RedisCacheManager.builder(factory)
                ...
                .withInitialCacheConfigurations(Map.of(
                        "mentorProfiles", defaultConfig.entryTtl(Duration.ofMinutes(10)),
                        "mentorAvailability", defaultConfig.entryTtl(Duration.ofMinutes(2)),
                        "topMentors", defaultConfig.entryTtl(Duration.ofMinutes(30))
                ))
                .build();
    }
}
